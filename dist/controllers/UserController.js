...
class UserController {
    ...
    static verify(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const user = yield User_1.default.findOneAndUpdate({ email: email, verificationToken: verificationToken, verification_token_time: { $gt: newdates } }, { verified: true }, { new: true });
                if (user) {
                    res.send(user);
                }
                else {
    ...
    static sendResetPasswordEmail(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const updateUser = yield User_1.default.findOneAndUpdate({ email: email }, { updated_at: new Date(), reset_password_token: resetPasswordToken,
